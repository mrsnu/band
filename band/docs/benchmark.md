...
* `profile_copy_computation_ratio`: Ratio of computation / input-ouput copy in `list[int]`. Used for latency estimation for each device type (e.g., CPU, GPU, DSP, NPU). The length of the list should be equal to the 4 (`DeviceFlag::kBandNumDeviceFlag`). [default: 30000, 30000, 30000, 30000]
