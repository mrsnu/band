...
BAND_CAPI_EXPORT extern BandConfig *BandConfigCreate(const void *config_data,
                                                     size_t config_size);
BAND_CAPI_EXPORT extern BandConfig *
BandConfigCreateFromFile(const char *config_path);
...
BAND_CAPI_EXPORT extern BandStatus
BandModelAddFromBuffer(BandModel *model, BandBackendType backend_type,
                       const void *model_data, size_t model_size);
BAND_CAPI_EXPORT extern BandStatus
BandModelAddFromFile(BandModel *model, BandBackendType backend_type,
...
BAND_CAPI_EXPORT extern BandQuantization
BandTensorGetQuantization(BandTensor *tensor);
...
BAND_CAPI_EXPORT extern BandTensor *
BandEngineCreateInputTensor(BandEngine *engine, BandModel *model, int index);
// Create a output tensor for given model's n'th index
BAND_CAPI_EXPORT extern BandTensor *
BandEngineCreateOutputTensor(BandEngine *engine, BandModel *model, int index);
BAND_CAPI_EXPORT extern BandStatus
BandEngineRequestSync(BandEngine *engine, BandModel *model,
                      BandTensor **input_tensors, BandTensor **output_tensors);
BAND_CAPI_EXPORT extern BandRequestHandle
BandEngineRequestAsync(BandEngine *engine, BandModel *model,
